...
def save_answers(subject_id: str, topic_id: int, snippet_id: int, question_id: int, question_text: str, answer_text: str):
    answers = answer_text.split(',')
    for index, answer in enumerate(answers):
        print(f'Answer to {question_text}: {index}.{answer.strip()}')
