from kml.utils.constants import SENTENCE_BOUNDARIES, TAG_TYPE, WORD_BOUNDARIES
...
class ParseKML:
    ...
    def next_word(self):
        ...
        if next_char in ['"', "'"]:
            ...
            # remove hanging quotes
            self.delete_chars(self.cursor_pos + 1, 1)
            self.delete_chars(end - 1, 1)
        else:
